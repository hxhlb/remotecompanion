...
- (void)viewDidLoad {
    ...
    _sections = @[
        ...
        @[
            ...
            @{ @"name": @"Ldrestart", @"command": @"ldrestart", @"icon": @"arrow.clockwise" },
            @{ @"name": @"Userspace Reboot", @"command": @"userspace-reboot", @"icon": @"restart.circle" },
            @{ @"name": @"UICache", @"command": @"uicache", @"icon": @"square.grid.2x2" },
